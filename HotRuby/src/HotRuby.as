package  
{
	...
	public final class HotRuby extends Sprite
	{
		 ...
		 * @private
		 */
		private function runOpcode(opcode:Array, classObj:Object, methodName:String, 
	...
	//					break;
					...
					case "defineclass" :
						...
						var isRedefine:Boolean = (parentClass == this.falseObj);
		 ...
		 * @param {String} str
		 */
		private function printDebug(str:String):void 
		{
			switch(this.env) 
			{
				case "browser":
					var div:Object = document.createElement("div");
					var text:Object = document.createTextNode(str);
		...
		private var classes:Object = {
			"Object" : {
				"==" : function(recver:Object, args:Array):Object {
					return recver == args[0] ? this.trueObj : this.falseObj;	
				},
				
				"to_s" : function(recver:Object):Object {
			...
			"TrueClass" : {
				"&" : function(recver:Object, args:Array):Boolean {
			...
			"Proc" : {
				"initialize" : function(recver:Object, args:Array):void {
			...
			"Float" : {
				"+" : function(recver:Object, args:Array):Number {
				...
				"<=>" : function(recver:Object, args:Array):int {
					if(recver > args[0])
						return 1;
			...
			"Array" : {
				"length" : function(recver:Object):int {
					return recver.__native.length;
				},
				
				"size" : function(recver:Object):int {
					return recver.__native.length;
				},
				...
				"[]=" : function(recver:Object, args:Array):void {
					recver.__native[args[0]] = args[1];
				},
				
				"join" : function(recver:Object, args:Array):Object {
					return this.createRubyString(recver.__native.join(args[0]));
				},
				
				"to_s" : function(recver:Object, args:Array):Object {
					return this.createRubyString(recver.__native.join(args[0]));
				}
			},
			...
			"Range" : {
				...
				"begin" : function(recver:Object):Object {
					return recver.__instanceVars.first;
				},
				
				"first" : function(recver:Object):Object {
					return recver.__instanceVars.first;
				},
				
				"end" : function(recver:Object):Object {
					return recver.__instanceVars.last;
				},
				
				"last" : function(recver:Object):Object {
					return recver.__instanceVars.last;
				},
				
				"exclude_end?" : function(recver:Object):int {
			...
			"Time" : {
				...
				"to_f" : function(recver:Object):Number {
